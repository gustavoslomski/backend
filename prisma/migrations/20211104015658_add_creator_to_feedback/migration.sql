/*
  ...
  - Added the required column `creator_id` to the `feedbacks` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_feedbacks" ("author_id", "created_at", "date", "id", "improvement", "maintain", "message", "suggestion", "target_id") SELECT "author_id", "created_at", "date", "id", "improvement", "maintain", "message", "suggestion", "target_id" FROM "feedbacks";
